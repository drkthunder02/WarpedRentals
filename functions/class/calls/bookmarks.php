...
class Bookmarks extends \W4RP\ESI {
    ...
    public function ListBookmarks($id, $type) {
        
        $url = $this->prefix . $type . '/' . $id . '/bookmarks/?datasource=tranquility';
        $header = 'Authorization: Bearer ' . $this->accessToken;
        
        return $this->GetESIData($url, $this->userAgent, $header);
    }
    
    public function ListBookmarkFolders($id, $type) {
        
        $url = $this->prefix . $type . '/' . $id . '/bookmarks/folders/?datasource=tranquility';
        $header = 'Authorization: Bearer ' . $this->accessToken;
