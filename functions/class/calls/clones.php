...
class Clones extends \W4RP\ESI {
    ...
    public function GetClones($id) {
        $url = $this->prefix . $id . '/clones/?datasource=tranquility';
        
        return $this->GetESIData($url, $this->userAgent, $header);
    }
    
    public function GetImplants($id) {
        $url = $this->prefix . $id . '/implants/?datasource=tranquility';
