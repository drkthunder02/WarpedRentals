...
class Killmails extends \W4RP\ESI {
    ...
    public function GetCharacterKillmails($id) {
        $url = $this->prefix . '/characters/' . $id . '/killmails/recent/?datasource=tranquility';
        $header = 'Authorization: Bearer ' . $this->accessToken;
        
        return $this->GetESIData($url, $this->userAgent, $header);
    }
    
    public function GetCorporationKillmails($id) {
        $url = $this->prefix . '/corporations/' . $id . '/killmails/recent/?datasource=tranquility';
        $header = 'Authorization: Bearer ' . $this->accessToken;
        
        return $this->GetESIData($url, $this->userAgent, $header);
    }
    
    public function GetKillmail($id, $hash) {
        $url = $this->prefix . '/killmails/' . $id . '/' . $hash . '/?datasource=tranquility';
