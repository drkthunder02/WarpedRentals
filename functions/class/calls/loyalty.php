...
class Loyalty extends \W4RP\ESI {
    ...
    public function GetLoyaltyPoints($id) {
        $url = $this->prefix . '/characters/' . $id . '/loyalty/points/?datasource=tranquility';
        $header = 'Authorization: Bearer ' . $this->accessToken;
        
        return $this->GetESIData($url, $this->userAgent, $header);
    }
    
    public function GetLoyaltyStoreOffers($id) {
        $url = $this->prefix . '/loyalty/stores/' . $id . '/offers/?datasource=tranquility';
